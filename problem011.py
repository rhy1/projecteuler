...
while y < 20:
	x = 0
	while x < 16:
		mul = MATRIX[y][x] * MATRIX[y][x + 1] * MATRIX[y][x + 2] * MATRIX[y][x + 3]
		if mul > result:
			result = mul
		x += 1
	y += 1
...
while x < 20:
	y = 0
	while y < 16:
		mul = MATRIX[y][x] * MATRIX[y + 1][x] * MATRIX[y + 2][x] * MATRIX[y + 3][x]
		if mul > result:
			result = mul
		y += 1
	x += 1
...
while x < 16:
	y = 0
	while y < 16:
		mul = MATRIX[y][x] * MATRIX[y + 1][x + 1] * MATRIX[y + 2][x + 2] * MATRIX[y + 3][x + 3]
		if mul > result:
			result = mul
		y += 1
	x += 1
